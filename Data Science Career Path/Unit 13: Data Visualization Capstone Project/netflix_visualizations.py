...
plt.savefig("netflix_quarterly_stocks_distribution.png")
plt.show()
...
plt.legend(labels)
plt.title("Revenue & Earnings By Quarter For 2017")
...
x_labels = ['Jan 2017', 'Feb 2017', 'Mar 2017', 'Apr 2017', 'May 2017', 'Jun 2017', /
...
plt.savefig("netflix_dowjones_stock_prices.png", bbox_inches="tight")
plt.show()
