...
SELECT date, AVG(money_in), AVG(money_in) FROM transactions GROUP BY date;
SELECT date, ROUND(AVG(money_in),2), ROUND(AVG(money_in),2) FROM transactions GROUP BY date;
SELECT date, AVG(money_in) AS "Avg Buy", AVG(money_in) AS "Avg Sell" FROM transactions GROUP BY date;