...
def find_best_night(availability_table):
    ...
    for key, value in availability_table.items():
        if value > best_night_value:
            best_night_value = value
            best_night_key = key
    
    return best_night_key
...
The Sorcery Society is able to host "{game}" night and hopes you will attend. Come on by {day_of_week} and have a big blast!
