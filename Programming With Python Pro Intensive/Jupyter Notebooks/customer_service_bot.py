...
def existing_customer():
    options_message = "What kind of support do you need?\n"    "[1] Television Support\n"    "[2] Internet Support\n"    "[3] Speak to a support representative"
...
def new_customer():
    options_message = "We're excited to have you join the DNS family, how can we help you?\n"    "[1] Sign up for service.\n"    "[2] Schedule a home visit.\n"    "[3] Speak to a sales representative"
...
def television_support():
    options_message = "What is the nature of your problem?\n"    "[1] I can't access certain channels.\n"    "[2] My picture is blurry.\n"    "[3] I keep losing service.\n"    "[4] Other issues."
    ...
    if response == "1":
        ...
        print("Is it rainging outside? If so, wait until it is not rainging and then try again.")
        did_that_help()
    elif response == "4":
        live_rep("support")
    else:
...
def internet_support():
    options_message = "What is the nature of your problem?\n"    "[1] I can't conncet to the internet.\n"    "[2] My connection is very slow.\n"    "[3] I can't access certain sites.\n"    "[4] Other issues."
...
def did_that_help():
    print("Was your problem fixed? \n [1] Yes \n [2] No.")
    response = input("Please enter the number corresponding to your choice: ")
    
    if response == "1":
        print("Thank you for contacting us today.")
    elif response == "2":
        options_message = "Would you like to talk to a live representative or schedule a home visit?\n"        "[1] Live representative"        "[2] Home visit"
...
def sign_up():
    options_message = "Great choice, friend! We're excited to have you join the DNS family! Please select the package you are interested in signing up for.\n"            "[1] Bundle Deal (Internet + Cable)\n"            "[2] Internet\n"            "[3] Cable"
